...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], ng_uikit_pro_standard__WEBPACK_IMPORTED_MODULE_2__["MDBBootstrapModulesPro"].forRoot(), _shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], _home_home_module__WEBPACK_IMPORTED_MODULE_6__["HomeModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], ng_uikit_pro_standard__WEBPACK_IMPORTED_MODULE_2__["MDBRootModules"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], _home_home_module__WEBPACK_IMPORTED_MODULE_6__["HomeModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppCommsCommsServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CommsService", function () {
      return CommsService;
    });
    /* harmony import */
    ...
    var CommsService = /*#__PURE__*/function () {
      function CommsService() {
        _classCallCheck(this, CommsService);

        this.connectionSocket = null;
        this.messages = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](null);
      }

      _createClass(CommsService, [{
        key: "connect",
        value: function connect(ipAndPort) {
          var _this = this;
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      _context.prev = 0;
                      _context.next = 3;
                      return Object(rxjs_webSocket__WEBPACK_IMPORTED_MODULE_2__["webSocket"])("ws://".concat(ipAndPort));

                    case 3:
                      this.connectionSocket = _context.sent;
                      this.connectionSocket.asObservable().subscribe(function (newMesage) {
                        if (newMesage) {
                          console.log("data rx: ".concat(JSON.stringify(newMesage)));

                          _this2.messages.next(newMesage);
                        }
                      });
                      resolve();
                      _context.next = 11;
        ...
        value: function send(message) {
          ...
          return new Promise(function (resolve, reject) {
            try {
              _this3.connectionSocket.next(message);
    ...
    CommsService.ɵfac = function CommsService_Factory(t) {
      return new (t || CommsService)();
    };

    CommsService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
      token: CommsService,
      factory: CommsService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](CommsService, [{
  ...
  function srcAppHomeHomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HomeModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], ng_uikit_pro_standard__WEBPACK_IMPORTED_MODULE_3__["MDBBootstrapModulesPro"].forRoot(), _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](HomeModule, {
        declarations: [_home_home_component__WEBPACK_IMPORTED_MODULE_2__["HomeComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], ng_uikit_pro_standard__WEBPACK_IMPORTED_MODULE_3__["MDBRootModules"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppHomeHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _comms_comms_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../comms/comms.service */
    "./src/app/comms/comms.service.ts");
    /* harmony import */
    ...
    var ng_uikit_pro_standard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ng-uikit-pro-standard */
    "./node_modules/ng-uikit-pro-standard/__ivy_ngcc__/fesm2015/ng-uikit-pro-standard.js");
    /* harmony import */
    ...
    function HomeComponent_mdb_card_text_21_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var HomeComponent = /*#__PURE__*/function () {
      ...
      _createClass(HomeComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.comms.messages.subscribe(function (newMessage) {
            if (newMessage) {
              _this4.receivedData = "".concat(newMessage.Command, ": ").concat(newMessage.Data);
            }
          });
        }
      }, {
        ...
        value: function send() {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
            ...
            var newCommand, newData, newMessage;
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    newCommand = this.commandAndData.split(" ")[0];
                    newData = this.commandAndData.substr(this.commandAndData.indexOf(" ") + 1); //special command to start websocket connection
                    ...
                    _context2.next = 5;
                    return this.comms.connect(newData)["catch"](function (err) {
                      _this5.receivedData = err;
                    });
                  ...
                  case 7:
                    //send everything else to websockets
                    newMessage = {
                      Command: newCommand,
                      Data: newData
                    };
                    console.log("tx: ".concat(JSON.stringify(newMessage)));
                    this.comms.send(newMessage)["catch"](function (err) {
                      _this5.receivedData = err;
                    });
    ...
    HomeComponent.ɵfac = function HomeComponent_Factory(t) {
      return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_comms_comms_service__WEBPACK_IMPORTED_MODULE_2__["CommsService"]));
    };
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      decls: 22,
      vars: 2,
      consts: [[1, "view", 2, "background-color", "#37474F", "background-size", "cover"], [1, "mask", "align-items-center"], [1, "container", 2, "padding-top", "1rem"], ["mdbInput", "", "type", "text", "placeholder", "Enter string to send", 1, "form-control", 3, "ngModel", "ngModelChange"], ["mdbBtn", "", "type", "button", "color", "primary", "block", "true", "mdbWavesEffect", "", 3, "click"], [4, "ngIf"]],
      template: function HomeComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_11_listener($event) {
            return ctx.commandAndData = $event;
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](HomeComponent, [{
        ...
        return [{
          type: _comms_comms_service__WEBPACK_IMPORTED_MODULE_2__["CommsService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppSharedNavbarNavbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    NavbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 0,
      consts: [["SideClass", "navbar navbar-expand-lg navbar-dark special-color-dark"], ["src", "../../../assets/saphi -logo-navbar.png", "height", "30", "alt", "", 2, "padding-right", "1rem"]],
      ...
      directives: [ng_uikit_pro_standard__WEBPACK_IMPORTED_MODULE_1__["NavbarComponent"], ng_uikit_pro_standard__WEBPACK_IMPORTED_MODULE_1__["LogoComponent"]],
  ...
  function srcAppSharedSharedModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    SharedModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], ng_uikit_pro_standard__WEBPACK_IMPORTED_MODULE_3__["MDBBootstrapModulesPro"].forRoot()]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](SharedModule, {
        declarations: [_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_2__["NavbarComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], ng_uikit_pro_standard__WEBPACK_IMPORTED_MODULE_3__["MDBRootModules"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\catch\Documents\GitHub\nodejs-embedded-boiler\ui\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
